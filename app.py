...
# We use 'vertical_alignment="center"' to make logo and text line up perfectly
col1, col2 = st.columns([1.2, 5], gap="medium", vertical_alignment="center")

with col1:
    try:
        # 'use_container_width=True' makes it sharper by using full column space
...
with col2:
    # Removed extra padding/margins to tighten the look
    st.markdown("""
...
# --- 3. AI LOGIC (Hidden Backend) ---
API_KEY = "AIzaSyB4e0pOQ628V0E6sxBG499Vi1RCEZhXsIk"
